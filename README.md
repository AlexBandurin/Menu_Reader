...
To make this application accessible to any user on the web, it is hosted on Heroku, a cloud platform (https://heroku.com). Flask was used to develop this application. <br>
