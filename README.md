...
## Model Building
The table with texts and their corresponding features has been manually labelled as a "menu item" or not (0 or 1). This labeled dataset was then ready to be sent 
